...
plain_text = '00 04 12 14 12 04 12 00 0C 00 13 11 08 23 19 19'
print()
print("Plain Text   :   ", plain_text)
plain_text = bytes.fromhex(
    '00 04 12 14 12 04 12 00 0C 00 13 11 08 23 19 19')  # 32 43 f6 a8 88 5a 30 8d 31 31 98 a2 e0 37 07 34
...
temp = str(cipher_text_hex).upper()
cipher_text_hex = ""
for i in range(0, len(temp), 2):
    cipher_text_hex += temp[i:i + 2] + " "
